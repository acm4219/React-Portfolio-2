...
function ProjectCard(){
    return(
        <div>
            <div className="card">
                 <h3 className="card-title pl-2 pt-2">Recent Projects</h3>
            </div>
                 <br />
            <div className="container">
            <div className="card">  
                
                <h5 className="card-title pl-2 pt-2">Cup of Sugar</h5>
                <hr/>
            
                <img className="w-75 p-3 h-75 d-inline-block ml-3" src={process.env.PUBLIC_URL + "/photoAssets/cupofsugar.JPG"} alt="cupofsugarentry" />
                ...
                <div className="card">  
                    ...
                    <br />
                <div className="card">
                    <h5 className="card-title pl-2 pt-2">CLI Employee Tracker</h5>
                    <hr />
                 ...
                 <br />
                <div className="card">
                     <h5 className="card-title pl-2 pt-2">Note Taker App</h5>
                         <hr />
                ...
                <div className="card">
                    ...
                    <br />
                <div className="card">
                    <h5 className="card-title pl-2 pt-2">Five Day Weather Forecast</h5>
                    <hr />
                    ...
                    <br />
                <div className="card">
                    <h5 className="card-title pl-2 pt-2">Daily Planner</h5>
                       <hr />
